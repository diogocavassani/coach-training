...
6. API retorna metricas, insights, aderencia ao planejamento, series de carga/pace e `treinosJanela` (12 semanas).
7. Professor analisa cards, graficos, aderencia e insights.
